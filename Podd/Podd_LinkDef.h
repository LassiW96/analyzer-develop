...
#pragma link C++ class FadcStandaloneAnalyzer + ;
...
#pragma link C++ class Podd::TDCData + ;
...
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         Double_t &, const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         Float_t &, const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         Long64_t &, const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         ULong64_t &, const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *, Int_t &,  \
                                         const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *, UInt_t &, \
                                         const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         Short_t &, const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         UShort_t &, const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *, Char_t &, \
                                         const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         UChar_t &, const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
...
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         UChar_t **&, const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         std::vector<int> &, const Int_t *);
#pragma link C++ function THaVar::THaVar(                                      \
    const char *, const char *, std::vector<unsigned int> &, const Int_t *);
#pragma link C++ function THaVar::THaVar(                                      \
    const char *, const char *, std::vector<double> &, const Int_t *);
#pragma link C++ function THaVar::THaVar(const char *, const char *,           \
                                         std::vector<float> &, const Int_t *);

#pragma read sourceClass = "Podd::MultiFileRun" source =                       \
    "std::string fFilenamePattern" version = "[1]" targetClass =               \
        "Podd::MultiFileRun" target = "fFileList" embed = "true" include =     \
            "vector,string" code =                                             \
                "{ fFileList.assign(1, onfile.fFilenamePattern); }"

#pragma read sourceClass = "THaRunParameters" source =                         \
    "TArrayI fPrescale" version = "[1]" targetClass =                          \
        "THaRunParameters" target = "fPrescale" embed = "true" include =       \
            "TArrayI.h,TMath.h,Decoder.h,array" code =                         \
                "{ int n = TMath::Min((Int_t)Decoder::MAX_PSFACT,   \
                             onfile.fPrescale.GetSize());  \
          for( int i=0; i<n; ++i)                          \
            fPrescale.at(i) = onfile.fPrescale[i]; }"

#pragma read sourceClass = "THaRun" source = "UInt_t fMaxScan" version =       \
    "[7]" targetClass = "THaRun" target = "fMinScan" embed = "true" include =  \
        "DAQInfoExtra.h" code =                                                \
            "{ fMinScan = DAQInfoExtra::GetMinScan(newObj); \
